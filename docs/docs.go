...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.Account"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.SwaggerLoginResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/response.SwaggerSignUpResponse"
                        }
                    },
                    "400": {
                        "description": "The user has made a bad request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.Collection"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "response.SwaggerSignUpResponse": {
            "type": "object",
            "properties": {
                "access_token": {
                    "type": "string",
